...
from user_app.views import (logout_view, login_view, get_all_users,SecretQuestionListView, UserRegistrationView,
                                     UserProfileView, PasswordResetRequestView, VerifySecretAnswerView, SetNewPasswordView, ChangePasswordView, GetSecretQuestion)
