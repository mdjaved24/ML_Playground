...
def preprocess_and_train(df, config):
    try:
        ...
        return ( feature_types, categorical_values, model, feature_encoder, scaler, target_encoder, accuracy )
...
def load_model_and_predict(model, features, columns, encoder=None, scaler=None, target_encoder=None):
    try:
