              ...
              <div className="flex justify-between items-center">
                ...
                {!editMode ? (
                  <button
                    ...
                    className="flex items-center bg-white text-purple-600 px-4 py-2 hover:cursor-pointer rounded-lg shadow hover:bg-gray-100 transition"
                  >
                  ...
                  <div className="flex space-x-3">
                    <button
                      onClick={handleSave}
                      className="flex items-center bg-white text-green-600 px-4 py-2 hover:cursor-pointer rounded-lg shadow hover:bg-gray-100 transition"
                    >
                      <SaveIcon className="mr-2" /> Save Changes
                    </button>
                    <button
                      onClick={handleCancel}
                      className="flex items-center bg-white text-gray-600 px-4 py-2 hover:cursor-pointer rounded-lg shadow hover:bg-gray-100 transition"
                    >
