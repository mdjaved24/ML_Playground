...
if (uniqueLabels.size < 2) {
  alert("⚠️ The selected target column contains only one class (e.g., only 0). Please choose a target with at least two classes.");
  return;
}
  ...
  if (uniqueValues.length < 2) {
    alert("⚠️ Model training will fail: The selected target column has only one unique value.");
    setTargetType(null);
    return;
  }
