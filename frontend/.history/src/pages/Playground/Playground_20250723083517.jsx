          ...
          {results && (
            <div className="bg-white rounded-xl shadow-md p-6 border border-[var(--color-gray-200)]">
              ...
              <button
                ...
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-gradient-to-r from-[var(--color-accent-500)] to-[var(--color-accent-600)] hover:from-[var(--color-accent-600)] hover:to-[var(--color-accent-700)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--color-accent-500)] transition backdrop-blur-sm cursor-pointer"
              >
                Save Model
              </button>
              </div>
