...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    if (error.includes("Target column must contain at least two unique classes")) {
    toast.error("Please select a target column with at least two different values (e.g., 0 and 1)");
  }
  toast.error(error)
  } finally {
    setIsLoading(false);
