...
function Dashboard() {
  ...
  const metrics = [
    ...
    { 
      title: "Avg Accuracy", 
      value: `${dashboardData.avg_accuracy.toFixed(2)}%`, 
    ...
    { 
      ...
      value: `${(dashboardData.avg_training_time).toFixed(2)}s`, // Convert seconds to minutes
 ...
 const recentActivity = dashboardData.recent_activity.map(model => {
  ...
  const performanceData = [
    { name: 'High (>90%)', value: 8 },
    { name: 'Good (80-90%)', value: 10 },
    { name: 'Fair (70-80%)', value: 4 },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
           <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200 lg:col-span-2">
            <div className="px-6 py-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-500 mt-1">
                Overview of your model ecosystem
              </p>
            </div>
            <div className="p-6 grid grid-cols-2 gap-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                <h3 className="text-sm font-medium text-blue-800">Best Performing Model</h3>
                <p className="text-xl font-bold mt-1">House Price Predictor</p>
                <p className="text-sm text-blue-600">98.6% accuracy</p>
              </div>
              <div className="bg-green-50 p-4 rounded-lg">
                <h3 className="text-sm font-medium text-green-800">Most Used Model</h3>
                <p className="text-xl font-bold mt-1">Customer Churn</p>
                <p className="text-sm text-green-600">24 predictions this week</p>
              </div>
              <div className="bg-purple-50 p-4 rounded-lg">
                <h3 className="text-sm font-medium text-purple-800">Fastest Training</h3>
                <p className="text-xl font-bold mt-1">Sales Forecast</p>
                <p className="text-sm text-purple-600">12.3 seconds</p>
              </div>
              <div className="bg-yellow-50 p-4 rounded-lg">
                <h3 className="text-sm font-medium text-yellow-800">Newest Model</h3>
                <p className="text-xl font-bold mt-1">Image Classifier</p>
                <p className="text-sm text-yellow-600">Created today</p>
              </div>
            </div>
          </div>
