    ...
    const fetchDashboardData = async () => {
      try {
        ...
        console.log(dashboardData);
          ...
          if (label.startsWith("Fair")) return "Fair";
          if (label.startsWith("Poor")) return "Poor";
          return label;
        };

        const formattedData = dashboardData.performance_distribution.map(item => ({
          name: shortenLabel(item.performance_range),
          fullLabel: item.performance_range, // Optional: use for tooltip
          value: item.count,
        }));
