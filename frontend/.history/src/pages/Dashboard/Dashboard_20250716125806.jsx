...
function Dashboard() {
 ...
 const metrics = useMemo(() => {
  ...
  const accTrend = recentAvgAcc != null && avgAccuracy
    ? ((recentAvgAcc - avgAccuracy) / avgAccuracy) * 100
    : null;

  // ✅ Avg Training Time trend in seconds (not percentage)
  ...
  const timeTrend = recentTrainTime != null
