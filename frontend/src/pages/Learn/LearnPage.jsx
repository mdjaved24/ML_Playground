          ...
          <section id="what-is-ml" className="mb-12">
            ...
            <div className="prose max-w-none">
              ...
              <div className="my-6 p-4 bg-[var(--color-gray-100)] rounded-lg">
                ...
                <img src="/ml-workflow.png" alt="Machine Learning Workflow" className="w-full max-w-2xl mx-auto rounded border border-[var(--color-gray-200)]" />
          ...
          <section id="model-selection" className="mb-12">
            ...
            <div className="prose max-w-none">
              ...
              <div className="my-6">
                ...
                <img src="/algorithm-selection.png" alt="Machine Learning Algorithm Selection Guide" className="w-full max-w-2xl mx-auto rounded border border-[var(--color-gray-200)]" />
          ...
          <section id="cross-validation" className="mb-12">
            ...
            <div className="prose max-w-none">
              ...
              <div className="my-6">
                ...
                <img src="/cross-validation.png" alt="Cross-Validation Techniques" className="w-full max-w-2xl mx-auto rounded border border-[var(--color-gray-200)]" />
          ...
          <section id="classification-metrics" className="mb-12">
            ...
            <div className="prose max-w-none">
              ...
              <div className="my-6">
                ...
                <img src="/confusion-matrix.png" alt="Confusion Matrix" className="w-full max-w-md mx-auto rounded border border-[var(--color-gray-200)]" />
          ...
          <section id="bias-variance" className="mb-12">
            ...
            <div className="prose max-w-none">
              ...
              <div className="my-6">
                ...
                <img src="/bias-variance.png" alt="Bias-Variance Tradeoff" className="w-full max-w-2xl mx-auto rounded border border-[var(--color-gray-200)]" />
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5000)`}
              ...
              <div className="my-6">
                ...
                <img src="/api-deployment.png" alt="API Deployment Architecture" className="w-full max-w-2xl mx-auto rounded border border-[var(--color-gray-200)]" />
